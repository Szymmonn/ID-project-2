...
"[project]/src/app/pozycje/edytuj/[id]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PozycjaEdytujPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!loaded) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOne"])("pozycje", id).then((res)=>{
                const p = res.data;
                setSkrot(p.skrot);
                setPelnaNazwa(p.pelna_nazwa);
            }).catch((err)=>console.error("Błąd pobierania pozycji:", err)).finally(()=>setLoaded(true));
        }
    }, [
        loaded,
        id
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateOne"])("pozycje", id, payload);
            router.push("/pozycje");
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__274bec77._.js.map