...
"[project]/src/app/sezony/edytuj/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SezonEdytujPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SezonEdytujPage.useEffect": ()=>{
            if (!loaded) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOne"])("sezony", id).then({
                    "SezonEdytujPage.useEffect": (res)=>{
                        const s = res.data;
                        setDataPoczatek(s.data_poczatek);
                        setDataKoniec(s.data_koniec);
                        setUwagi(s.uwagi || "");
                    }
                }["SezonEdytujPage.useEffect"]).catch({
                    "SezonEdytujPage.useEffect": (err)=>console.error("Błąd pobierania sezonu:", err)
                }["SezonEdytujPage.useEffect"]).finally({
                    "SezonEdytujPage.useEffect": ()=>setLoaded(true)
                }["SezonEdytujPage.useEffect"]);
            }
        }
    }["SezonEdytujPage.useEffect"], [
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateOne"])("sezony", id, payload);
            router.push("/sezony");
        } catch (err) {
...
_s(SezonEdytujPage, "xar+yyENeO70N8oPHlXRLRZ7XE8=", false, function() {
    return [
...
_c = SezonEdytujPage;
var _c;
__turbopack_context__.k.register(_c, "SezonEdytujPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_14d2c817._.js.map