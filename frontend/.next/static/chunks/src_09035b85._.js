...
"[project]/src/app/sezony/dodaj/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SezonDodajPage() {
    ...
    const [idSezonu, setIdSezonu] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOne"])("sezony", payload);
            router.push("/sezony");
        } catch (err) {
...
_s(SezonDodajPage, "QjAVu2YN0hsY7079AHM/7f5LoDM=", false, function() {
    return [
...
_c = SezonDodajPage;
var _c;
__turbopack_context__.k.register(_c, "SezonDodajPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_09035b85._.js.map