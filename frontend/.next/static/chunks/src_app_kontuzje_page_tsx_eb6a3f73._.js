...
function KontuzjePage() {
    ...
    const fetchData = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/kontuzje/");
            setLista(res.data);
        } catch (err) {
    ...
    const handleDelete = async (k)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("/api/kontuzje/", {
                params: {
...
//# sourceMappingURL=src_app_kontuzje_page_tsx_eb6a3f73._.js.map