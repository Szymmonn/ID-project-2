...
"[project]/src/app/kraje/dodaj/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function KrajeDodajPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOne"])("kraje", {
                nazwa: nazwa.trim()
            });
            router.push("/kraje");
        } catch (err) {
...
_s(KrajeDodajPage, "usYuFdXuGEYJcVLDbJBiHQgDT+g=", false, function() {
    return [
...
_c = KrajeDodajPage;
var _c;
__turbopack_context__.k.register(_c, "KrajeDodajPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_46f5f665._.js.map